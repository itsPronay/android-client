...
@Composable
internal fun LoanRepaymentContent(
    loanId: Int,
    clientName: String,
    loanProductName: String,
    amountInArrears: Double?,
    ...
    Column(
        ...
        MifosTextFieldDropdown(
            ...
            options = if (loanRepaymentTemplate.paymentTypeOptions != null)
                loanRepaymentTemplate.paymentTypeOptions!!.map { it.name }
            else emptyList(),
            readOnly = true,
        )
